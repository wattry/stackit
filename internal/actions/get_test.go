...
func TestGetAction(t *testing.T) {
	t.Run("resolves PR number and fetches branches", func(t *testing.T) {
		...
		err := actions.GetAction(s.Context, "123", actions.GetOptions{})
	...
	t.Run("crawls ancestors via GitHub PRs", func(t *testing.T) {
		...
		err := actions.GetAction(s.Context, "feature-b", actions.GetOptions{})
		require.NoError(t, err)
	...
	t.Run("identifies and syncs local descendants", func(t *testing.T) {
		...
		err := actions.GetAction(s.Context, "feature-a", actions.GetOptions{})
		require.NoError(t, err)
	...
	t.Run("fails if uncommitted changes exist", func(t *testing.T) {
		...
		err := actions.GetAction(s.Context, "some-branch", actions.GetOptions{})
		require.Error(t, err)
